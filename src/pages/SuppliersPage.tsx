...
export default function SuppliersPage() {
  ...
  const handleAdd = () => {
    const s: Supplier = { id: Date.now().toString(), ...form, rating: 0, trip_id: '1' };
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-bold">الموردين</h3>
        ...
        {suppliers.map((sup, i) => (
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <StarRating rating={sup.rating} onRate={(r) => setSuppliers(suppliers.map(s => s.id === sup.id ? { ...s, rating: r } : s))} />
            </div>
